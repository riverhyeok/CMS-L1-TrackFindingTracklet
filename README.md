...
## 3. Create L1 track histograms & print summary of tracking performance
csh makeHists.csh L1TrkNtuple.root

root file name can be edited in L1TrackNtupleMaker_cfg.py's line 131: process.TFileService = cms.Service("TFileService", fileName = cms.string('L1TrkNtuple.root'), closeFileFast = cms.untracked.bool(True)). If rootFileName not specified, it defaults to TTbar_PU200_D76.root) 



makeHists.csh  make plots from root file by running ROOT macros L1TrackNtuplePlot.C & L1TrackQualityPlot.C
